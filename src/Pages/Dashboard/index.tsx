...
const Dashboard: React.FC = () => {
  ...
  const currentScreen = useSelector(
    (store: ApplicationStore) => store.dashboard.current_screen
  );
            ...
            <Nav className="sidenav">
              ...
              <NavItem>
                <FiGrid
                  ...
                  className="imgbtn"
                  color={
                    currentScreen === "VisaoGeral"
                      ? "var(--primary-color)"
                      : "#fff"
                  }
                />
                <NavLink
                  className={currentScreen === "VisaoGeral" ? "selected" : ""}
                  onClick={() => changeComponent("VisaoGeral")}
                  selected={currentScreen === "VisaoGeral"}
                >
                  Visão Geral
                </NavLink>
              </NavItem>
              <NavItem>
                ...
                <NavLink
                  className={
                    currentScreen === "ContaCorrente" ? "selected" : ""
                  }
                  onClick={() => changeComponent("ContaCorrente")}
                  selected={currentScreen === "ContaCorrente"}
                >
                  Conta Corrente
                </NavLink>
              </NavItem>
              <NavItem>
                ...
                <NavLink
                  className={
                    currentScreen === "AdicionarFundos" ? "selected" : ""
                  }
                  onClick={() => changeComponent("AdicionarFundos")}
                  selected={currentScreen === "AdicionarFundos"}
                >
                  Adicionar Fundos
                </NavLink>
              </NavItem>
              <NavItem>
                ...
                <NavLink
                  className={
                    currentScreen === "CartaoCredito" ? "selected" : ""
                  }
                  onClick={() => changeComponent("CartaoCredito")}
                  selected={currentScreen === "CartaoCredito"}
                >
                  Cartão de Crédito
                </NavLink>
              </NavItem>
              <NavItem>
                <FiCreditCard
                  ...
                  className="imgbtn"
                  color={
                    currentScreen === "PagarFatura"
                      ? "var(--primary-color)"
                      : "#fff"
                  }
                />
                <NavLink
                  className={currentScreen === "PagarFatura" ? "selected" : ""}
                  onClick={() => changeComponent("PagarFatura")}
                  selected={currentScreen === "PagarFatura"}
                >
                  Pagar Fatura
                </NavLink>
              </NavItem>
              <NavItem>
                <MdCompareArrows
                  ...
                  className="imgbtn"
                  color={
                    currentScreen === "Tranferencia"
                      ? "var(--primary-color)"
                      : "#fff"
                  }
                />
                <NavLink
                  className={currentScreen === "Tranferencia" ? "selected" : ""}
                  onClick={() => changeComponent("Tranferencia")}
                  selected={currentScreen === "Tranferencia"}
                >
                  Transferências
                </NavLink>
              </NavItem>
